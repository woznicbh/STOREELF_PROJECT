	...
	ANGULARJS_APP.filter('orderObjectBy', function() {
 	...
 	function STOREELFSQLThreadStatsController($scope, $http, $log, $interval){
		...
		$scope.getSQLJobDetails= function() {
			...
			$http({
			    method: 'POST',
			    url: STOREELF_ROOT_URI+'/Utility/ServerStatistics/SQL_thread_status',
			    //timeout: 30000,
...
/* 		$scope.getTimeout=function(){
			$http({
			    method: 'POST',
			    url: STOREELF_ROOT_URI+'/Utility/ServerStatistics/get_sql_timeout',
			    headers: {'Content-Type': 'application/x-www-form-urlencoded'}
			}).success(function(data, status) {
		...
		$scope.getThreadList= function() {
			...
			$http({
			    method: 'POST',
			    url: STOREELF_ROOT_URI+'/Utility/ServerStatistics/get_thread_list',
			    //timeout: 30000,
			    headers: {'Content-Type': 'application/x-www-form-urlencoded'}
			}).success(function(data, status) {
		...
		$scope.getDBConnectionList= function() {
			$http({
			    method: 'POST',
			    url: STOREELF_ROOT_URI+'/Utility/ServerStatistics/get_db_connection_list',
			    //timeout: 30000,
			    headers: {'Content-Type': 'application/x-www-form-urlencoded'}
			}).success(function(data, status) {
		...
		$scope.getSQLDetails= function(thread) {
			...
			$http({
			    method: 'POST',
			    url: STOREELF_ROOT_URI+'/Utility/ServerStatistics/get_thread_details',
			    //timeout: 30000,
		...
		$scope.setSQLDetails= function() {
			$http({
			    method: 'POST',
			    url: STOREELF_ROOT_URI+'/Utility/ServerStatistics/set_thread_details',
			    //timeout: 30000,
			    data: 
		...
		$scope.KILL_THREAD= function(sql) {
			$http({
			    method: 'POST',
			    url: STOREELF_ROOT_URI+'/Utility/ServerStatistics/kill_thread',
			    //timeout: 30000,
			    data: "SQL_ID="+sql,
			    headers: {'Content-Type': 'application/x-www-form-urlencoded'}
			}).success(function(data, status) {
		...
		$scope.CANCEL_SQL= function(sql) {
			$http({
			    method: 'POST',
			    url: STOREELF_ROOT_URI+'/Utility/ServerStatistics/cancel_sql',
			    //timeout: 30000,
			    data: "SQL_ID="+sql,
			    headers: {'Content-Type': 'application/x-www-form-urlencoded'}
			}).success(function(data, status) {
		...
		$scope.DISABLE_SQL= function(sql) {
			$http({
			    method: 'POST',
			    url: STOREELF_ROOT_URI+'/Utility/ServerStatistics/disable_sql',
			    //timeout: 30000,
			    data: "SQL_ID="+sql,
			    headers: {'Content-Type': 'application/x-www-form-urlencoded'}
			}).success(function(data, status) {
		...
		$scope.ENABLE_SQL= function(sql) {
			$http({
			    method: 'POST',
			    url: STOREELF_ROOT_URI+'/Utility/ServerStatistics/enable_sql',
			    //timeout: 30000,
			    data: "SQL_ID="+sql,
			    headers: {'Content-Type': 'application/x-www-form-urlencoded'}
			}).success(function(data, status) {
		...
		$scope.ALL=function(ACTION){
			...
			$http({
			    method: 'POST',
			    url: STOREELF_ROOT_URI+'/Utility/ServerStatistics/modify_all_sql',
			    //timeout: 30000,
