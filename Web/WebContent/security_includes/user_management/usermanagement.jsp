...
ANGULARJS_APP = angular.module('UserManagementSearchApp', []);

function UserSearchController($scope, $http){
	var post_url = STOREELF_ROOT_URI+'/Security/UserManagement/usermanagement';
	var userId='';
	$scope.result = 0;
...
<div ng-app="UserManagementSearchApp">
	<div ng-controller="UserSearchController" data-ng-init="init()">
		<div class="col-sm-12">
			<ol class="breadcrumb">
				<li><a>Security</a></li>
				...
				<div class="panel-body">
					<form name="form" class="form-horizontal" role="form" ng-enter="searchUsers(search)">
						<div class="form-group">
						    ...
						    <div class="col-sm-3">
						      <input name="userID" class="form-control" ng-model="search.userID" onclick="" value="" type="text" ng-init="search.userID=''" placeholder="User ID" />
						    </div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">User Name</label>
						    <div class="col-sm-3">
						      <input name="userName" class="form-control" ng-model="search.userName" onclick="" value="" type="text" ng-init="search.userName=''" placeholder="User First Name" />
						    </div>
						</div>
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<button ng-disabled="!(!!search.userID ||!!search.userName|| isLoading())" class="btn btn-default" type="button" ng-class="{true: 'btn-warning', false: 'btn-default'}[isActive]"
									ng-click="searchUsers(search)">{{button_search}}</button>
								<button ng-disabled="!(!!search.userID ||!!search.userName|| isLoading())" class="btn btn-default" type="button" style="margin-left:25px; ng-class="{true: 'btn-warning', false: 'btn-default'}[isActive]"
				...
				<table 
					...
					<tbody>
						<tr ng-repeat="user in userdetails">
							<td><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#userGroupDetailsModal" ng-click="loadUserGroupData(user.USERNAME)">{{user.USERNAME}} </button></td>
							<td ng-bind="user.FIRST_NAME"></td>
							<td ng-bind="user.LAST_NAME"></td>
							<td ng-bind="user.IS_ADMIN"></td>
							<!-- <td ng-bind="user.LAST_LOGIN_TS"></td> -->
