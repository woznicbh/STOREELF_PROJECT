...
//		String sql = null;
		...
		String jsp_include_page = "/dashboard_includes/server_statistics/SQL_thread_status.jsp";
		JsonArray root = null;
			...
			if ("POST".equals(request.getMethod())) {
				...
				try{
					 if(Constants.STOREELF_SQL_STMT_MAP.containsKey(SQL_ID)){
						 PreparedStatement stmt = Constants.STOREELF_SQL_STMT_MAP.get(SQL_ID);
...
//		String sql = null;
		String content = "-error-";
		PrintWriter responseWriter = null;
		String jsp_include_page = "/dashboard_includes/server_statistics/SQL_connection_status.jsp";
		JsonArray root = null;
	...
	String content = "-error-";
	PrintWriter responseWriter = null;
	String jsp_include_page = "/dashboard_includes/server_statistics/storeelfprop.jsp";
