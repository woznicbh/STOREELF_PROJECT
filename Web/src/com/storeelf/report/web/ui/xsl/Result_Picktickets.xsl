...
<xsl:stylesheet version="1.0"
	...
	<xsl:key name="keyval" match="form/rows/row"
		use="translate(concat(column[@colname='STATUS']/@value,column[@colname='SHIPNODE_KEY']/@value,column[@colname='PICKTICKET_NO']/@value),' ','')" />
	<xsl:template match="/">
		...
		<div class="results">
			...
			<div class="utilityresultdata">
				<table class="utilityresultdatatable">
					...
					<tbody>
						<xsl:for-each
							select="/form/rows/row[count(. | key('keyval', translate(concat(column[@colname='STATUS']/@value,column[@colname='SHIPNODE_KEY']/@value,column[@colname='PICKTICKET_NO']/@value),' ',''))[1]) = 1]">
							<xsl:variable name="keyvalue"
								select="translate(concat(column[@colname='STATUS']/@value,column[@colname='SHIPNODE_KEY']/@value,column[@colname='PICKTICKET_NO']/@value),' ','')" />
							...
							<tr>
								...
								<td style="display:none">
									...
									<table class="innertable">
										...
										<tbody>
											<xsl:for-each
												select="/form/rows/row[translate(concat(column[@colname='STATUS']/@value,column[@colname='SHIPNODE_KEY']/@value,column[@colname='PICKTICKET_NO']/@value),' ','')=$keyvalue]">
												<tr>
													<td>
